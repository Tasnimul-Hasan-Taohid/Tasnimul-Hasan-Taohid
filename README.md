...
hardware    : ESP32-C3, STM32, Arduino — firmware & embedded systems
passion     : Robotics • AgriTech • STEAM Education • Legacy-driven Impact
```
...
| Year | Award |
|------|-------|
| 2025 | 🥇 **Prothom Alo Inspiring 10** — Gold Medal (AgriTech) |
| 2025 | 🌍 **UNEP Environmental Impact Award** (w/ Bridge for Billions) |
| 2025 | 🎓 **Erasmus+ KA171** — International Mobility Grant |
| 2025 | 🚀 **Startup World Cup Bangladesh** — Top 6 |
| 2025 | 🏆 **Hult Prize Champion** |
| 2025 | 🏆 **SIMcubator Winner** |
| 2025 | 🏆 **Natecon Champion** |
| 2024 | ⚡ **Energy Innovation Challenge Champion** |
| 2024 | 🌐 **EWC Top 250 Globally** / National Champion |
| 2024 | 🔬 **BCSIR Champion** |
| 2023 | 🎨 **Bangabandhu Creative Talent Hunt Champion** |
...
### [Bortoni](https://bortonibd.com) — Sustainable AgriTech
> Connecting rural farmers with sustainable agriculture solutions. Founded January 2024 in Rajshahi, Bangladesh.

### Pikobot — Desk Companion Robot *(@ Xenon Industries)*
> ESP32-C3 powered robot with 50+ facial expressions, Pomodoro timer, weather station & motivational messages.
> 📺 [Watch Demo](https://youtu.be/6ndrZoAlMeg)
